...
export default async function handler(req, res) {
  ...
  try {
    // 1. Ajout du contact dans la liste Newsletter (#3)
  ...
  <tr><td align="center" style="padding:40px 20px;">
    <table width="580" cellpadding="0" cellspacing="0" border="0" style="max-width:580px;width:100%;background:#FFFFFF;">
      ...
      <tr><td style="padding:36px 48px;text-align:center;">
        <p style="font-size:14px;color:#6B5B4E;margin:0 0 24px;line-height:1.8;">
          Découvrez dès maintenant notre collection<br>de soins naturels et certifiés.
        </p>
      ...
      <tr><td style="background:#1C1612;padding:28px 48px;text-align:center;">
        ...
        <div style="font-size:11px;color:#6B5B4E;margin-bottom:12px;line-height:1.8;">
        ...
        <div style="font-size:10px;color:#4A3F38;line-height:1.8;">
          Vous recevez cet email car vous vous êtes inscrit(e) sur alyanco.com<br>
          <a href="https://alyanco.com" style="color:#4A3F38;text-decoration:none;">Se désinscrire</a>
          &nbsp;·&nbsp;
